...
public class InterpreterUtils {
    public static Literal literalCast(Literal source, Variable variable) throws InterpreterException {
        ...
        throw new InterpreterException("Unknown variable type for casting.");
    }
    ...
    private static Literal boolLiteralCast(Literal source) throws InterpreterException {
        if (BoolLiteral.class.equals(source.getClass())) {
            ...
            throw new InterpreterException("No cast from color to bool.");
        } else if (HexLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from hex to bool.");
            ...
            throw new InterpreterException("No cast from planet to bool.");
    ...
    private static Literal colorLiteralCast(Literal source) throws InterpreterException {
        if (BoolLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from bool to color.");
        } else if (ColorLiteral.class.equals(source.getClass())) {
            return new ColorLiteral(source.getValue());
        } else if (HexLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from hex to color.");
        } else if (IntLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from number to color.");
        } else if (PlanetLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from planet to color.");
        } else if (StringLiteral.class.equals(source.getClass())) {
            if(ScannerUtils.literalToType.get(source.getValue()) == Token.Type.ColorLiteral){
                return new ColorLiteral(source.getValue());
            }else{
                throw new InterpreterException("Wrong cast from string to color.");
            }
        } else if (UnitLiteral.class.equals(source.getClass())) {
    ...
    private static Literal hexLiteralCast(Literal source) throws InterpreterException {
        if (BoolLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from bool to hex.");
        } else if (ColorLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from color to hex.");
        } else if (HexLiteral.class.equals(source.getClass())) {
            ...
            if(string.charAt(0) == 'h'){
                try{
                    ...
                    throw new InterpreterException("Wrong hex index.");
                }
            }
            throw new InterpreterException("Wrong cast from hex to hex.");
        } else if (IntLiteral.class.equals(source.getClass())) {
            int value = Integer.parseInt(source.getValue());
            if(value < Constants.Board.HEX_NUMBER && value >= 0){
                return new HexLiteral("h"+value);
            }else{
                throw new InterpreterException("Wrong cast from number to hex.");
            }
        } else if (PlanetLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from planet to hex.");
        } else if (StringLiteral.class.equals(source.getClass())) {
            String string = source.getValue();
            if(string.charAt(0) == 'h'){
                try{
    ...
    private static Literal intLiteralCast(Literal source) throws InterpreterException {
        if (BoolLiteral.class.equals(source.getClass())) {
            ...
            throw new InterpreterException("Wrong cast from bool to number.");
        } else if (ColorLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from color to number.");
        } else if (HexLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from hex to number.");
        } else if (IntLiteral.class.equals(source.getClass())) {
            return new IntLiteral(source.getValue());
        } else if (PlanetLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from planet to number.");
        } else if (StringLiteral.class.equals(source.getClass())) {
            try{
                int value = Integer.parseInt(source.getValue());
                return new IntLiteral(""+value);
            }catch (NumberFormatException e){
                throw new InterpreterException("Wrong cast from string to number.");
            }
        } else if (UnitLiteral.class.equals(source.getClass())) {
    ...
    private static Literal planetLiteralCast(Literal source) throws InterpreterException {
        if (BoolLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from bool to planet.");
        } else if (ColorLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from color to planet.");
        } else if (HexLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from hex to planet.");
        } else if (IntLiteral.class.equals(source.getClass())) {
            int value = Integer.parseInt(source.getValue());
            if(value < Constants.Board.PLANET_NUMBER && value >= 0){
                return new HexLiteral("p"+value);
            }else{
                throw new InterpreterException("Wrong cast from number to planet.");
            }
        } else if (PlanetLiteral.class.equals(source.getClass())) {
            String string = source.getValue();
            if(string.charAt(0) == 'h'){
                try{
                    ...
                    throw new InterpreterException("Wrong planet index.");
                }
            }
            throw new InterpreterException("Wrong cast from planet to planet.");
        } else if (StringLiteral.class.equals(source.getClass())) {
            String string = source.getValue();
            if(string.charAt(0) == 'h'){
                try{
    ...
    private static Literal unitLiteralCast(Literal source) throws InterpreterException {
        if (BoolLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from bool to unit.");
        } else if (ColorLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from color to unit.");
        } else if (HexLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from hex to unit.");
        } else if (IntLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from number to unit.");
        } else if (PlanetLiteral.class.equals(source.getClass())) {
            throw new InterpreterException("No cast from planet to unit.");
        } else if (StringLiteral.class.equals(source.getClass())) {
            if(ScannerUtils.literalToType.get(source.getValue()) == Token.Type.UnitLiteral){
                return new ColorLiteral(source.getValue());
            }else{
                throw new InterpreterException("Wrong cast from string to unit.");
            }
        } else if (UnitLiteral.class.equals(source.getClass())) {
