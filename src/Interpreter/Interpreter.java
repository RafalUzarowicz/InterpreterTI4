...
public class Interpreter implements IVisitor {
    ...
    private final IOStream outStream;

    public Interpreter(Program program, Board board, IOStream outStream) {
    ...
    public void execute(boolean save) throws Exception {
        program.accept(this);
        if (save) {
    ...
    @Override
    public void visit(Parameters parameters) throws InterpreterException {
    ...
    @Override
    public void visit(BoolVariable boolVariable) {
        // This visitor doesn't need to visit this node.
    }

    @Override
    public void visit(ColorVariable colorVariable) {
        // This visitor doesn't need to visit this node.
    }

    @Override
    public void visit(HexVariable hexVariable) {
        // This visitor doesn't need to visit this node.
    }

    @Override
    public void visit(IntVariable intVariable) {
        // This visitor doesn't need to visit this node.
    }

    @Override
    public void visit(PlanetVariable planetVariable) {
        // This visitor doesn't need to visit this node.
    }
    ...
    @Override
    public void visit(UnitVariable unitVariable) {
        // This visitor doesn't need to visit this node.
    }
    ...
    @Override
    public void visit(FunctionCallValue functionCallValue) throws Exception {
    ...
    // Literals
    @Override
    public void visit(BoolLiteral boolLiteral) throws InterpreterException {
        environment.pushValue(InterpreterUtils.literalCast(boolLiteral, new BoolVariable("")));
    }

    @Override
    public void visit(ColorLiteral colorLiteral) throws InterpreterException {
        environment.pushValue(InterpreterUtils.literalCast(colorLiteral, new ColorVariable("")));
    }

    @Override
    public void visit(HexLiteral hexLiteral) throws InterpreterException {
        environment.pushValue(InterpreterUtils.literalCast(hexLiteral, new HexVariable("")));
    }

    @Override
    public void visit(IntLiteral intLiteral) throws InterpreterException {
    ...
    @Override
    public void visit(PlanetLiteral planetLiteral) throws InterpreterException {
        environment.pushValue(InterpreterUtils.literalCast(planetLiteral, new PlanetVariable("")));
    }

    @Override
    public void visit(StringLiteral stringLiteral) throws InterpreterException {
        environment.pushValue(InterpreterUtils.literalCast(stringLiteral, new StringVariable("")));
    }

    @Override
    public void visit(UnitLiteral unitLiteral) throws InterpreterException {
        environment.pushValue(InterpreterUtils.literalCast(unitLiteral, new UnitVariable("")));
    }

    // BoardStateCheck
    @Override
    public void visit(ActivationCheck activationCheck) throws Exception {
    ...
    @Override
    public void visit(HexStateCheck hexStateCheck) throws Exception {
    ...
    @Override
    public void visit(PlanetStateCheck planetStateCheck) throws Exception {
    ...
    @Override
    public void visit(PlayerStateCheck playerStateCheck) throws Exception {
    ...
    // Statements
    @Override
    public void visit(ArrayDeclaration arrayDeclaration) throws Exception {
        ...
        for (; i < arrayVariable.size(); ++i) {
            Literal literal = InterpreterUtils.literalCast(new Literal(""), variable);
            arrayVariable.setValue(i, literal);
        }
    }
    ...
    @Override
    public void visit(Break breakStm) {
        environment.setHasBroken(true);
    }

    @Override
    public void visit(Conditional conditional) throws Exception {
    ...
    @Override
    public void visit(Continue continueStm) {
        environment.setHasContinued(true);
    }

    @Override
    public void visit(FunctionCall functionCallStm) throws Exception {
    ...
    @Override
    public void visit(Return returnStm) throws Exception {
    ...
    // ConditionExpression
    @Override
    public void visit(OrCondition orCondition) throws Exception {
    ...
    @Override
    public void visit(AndCondition andCondition) throws Exception {
    ...
    @Override
    public void visit(EqualityCondition equalityCondition) throws Exception {
    ...
    @Override
    public void visit(RelationalCondition relationalCondition) throws Exception {
    ...
    @Override
    public void visit(MultiplyExpression multiplyExpression) throws Exception {
    ...
    @Override
    public void visit(NegativeUnaryExpression negativeUnaryExpression) throws Exception {
        negativeUnaryExpression.getUnaryExpression().accept(this);
        new NegativeOperator().accept(this);
    }

    @Override
    public void visit(NotUnaryExpression notUnaryExpression) throws Exception {
    ...
    // Operators
    @Override
    public void visit(AndOperator andOperator) throws InterpreterException {
    ...
    @Override
    public void visit(DivideOperator divideOperator) throws InterpreterException {
    ...
    @Override
    public void visit(EqualOperator equalOperator) throws InterpreterException {
    ...
    @Override
    public void visit(GreaterEqualOperator greaterEqualOperator) throws InterpreterException {
        IntLiteral right = (IntLiteral) InterpreterUtils.literalCast(environment.popValue(), new IntVariable(""));
        IntLiteral left = (IntLiteral) InterpreterUtils.literalCast(environment.popValue(), new IntVariable(""));
    ...
    @Override
    public void visit(GreaterOperator greaterOperator) throws InterpreterException {
        IntLiteral right = (IntLiteral) InterpreterUtils.literalCast(environment.popValue(), new IntVariable(""));
        IntLiteral left = (IntLiteral) InterpreterUtils.literalCast(environment.popValue(), new IntVariable(""));
        if (left.getClass().equals(IntLiteral.class) && right.getClass().equals(IntLiteral.class)) {
            int lVal = Integer.parseInt(left.getValue());
    ...
    @Override
    public void visit(LessEqualOperator lessEqualOperator) throws InterpreterException {
        IntLiteral right = (IntLiteral) InterpreterUtils.literalCast(environment.popValue(), new IntVariable(""));
        IntLiteral left = (IntLiteral) InterpreterUtils.literalCast(environment.popValue(), new IntVariable(""));
        if (left.getClass().equals(IntLiteral.class) && right.getClass().equals(IntLiteral.class)) {
            int lVal = Integer.parseInt(left.getValue());
    ...
    @Override
    public void visit(LessOperator lessOperator) throws InterpreterException {
        IntLiteral right = (IntLiteral) InterpreterUtils.literalCast(environment.popValue(), new IntVariable(""));
        IntLiteral left = (IntLiteral) InterpreterUtils.literalCast(environment.popValue(), new IntVariable(""));
        if (left.getClass().equals(IntLiteral.class) && right.getClass().equals(IntLiteral.class)) {
            int lVal = Integer.parseInt(left.getValue());
    ...
    @Override
    public void visit(MinusOperator minusOperator) throws InterpreterException {
        IntLiteral right = (IntLiteral) InterpreterUtils.literalCast(environment.popValue(), new IntVariable(""));
        IntLiteral left = (IntLiteral) InterpreterUtils.literalCast(environment.popValue(), new IntVariable(""));
        int lVal = Integer.parseInt(left.getValue());
        int rVal = Integer.parseInt(right.getValue());
    ...
    @Override
    public void visit(MultiplyOperator multiplyOperator) throws InterpreterException {
        IntLiteral left = (IntLiteral) InterpreterUtils.literalCast(environment.popValue(), new IntVariable(""));
        IntLiteral right = (IntLiteral) InterpreterUtils.literalCast(environment.popValue(), new IntVariable(""));
        int lVal = Integer.parseInt(left.getValue());
        int rVal = Integer.parseInt(right.getValue());
    ...
    @Override
    public void visit(NegativeOperator negativeOperator) throws InterpreterException {
    ...
    @Override
    public void visit(NotEqualOperator notEqualOperator) throws InterpreterException {
        Literal left = environment.popValue();
        Literal right = environment.popValue();
        environment.pushValue(new BoolLiteral((!left.getValue().equals(right.getValue())) ? "true" : "false"));
    }
    ...
    @Override
    public void visit(NotOperator notOperator) throws InterpreterException {
    ...
    @Override
    public void visit(OrOperator orOperator) throws InterpreterException {
        BoolLiteral left = (BoolLiteral) InterpreterUtils.literalCast(environment.popValue(), new BoolVariable(""));
        BoolLiteral right = (BoolLiteral) InterpreterUtils.literalCast(environment.popValue(), new BoolVariable(""));
        boolean lVal = left.getValue().equals("true");
        boolean rVal = right.getValue().equals("true");
    ...
    @Override
    public void visit(PlusOperator plusOperator) throws InterpreterException {
        IntLiteral left = (IntLiteral) InterpreterUtils.literalCast(environment.popValue(), new IntVariable(""));
        IntLiteral right = (IntLiteral) InterpreterUtils.literalCast(environment.popValue(), new IntVariable(""));
        int lVal = Integer.parseInt(left.getValue());
        int rVal = Integer.parseInt(right.getValue());
    ...
    // BoardChange
    @Override
    public void visit(BoardChange boardChange) throws Exception {
        boardChange.getPlayer().accept(this);
        boardChange.getPlayerAction().accept(this);
    }

    @Override
    public void visit(Activation activation) throws Exception {
        ColorLiteral player = (ColorLiteral) InterpreterUtils.literalCast(environment.popValue(), new ColorVariable(""));
    ...
    @Override
    public void visit(PlayerAction playerAction) {
        // This visitor doesn't need to visit this node.
    }

    @Override
    public void visit(UnitsAction unitsAction) throws Exception {
        ColorLiteral player = (ColorLiteral) InterpreterUtils.literalCast(environment.popValue(), new ColorVariable(""));
        Literal from = null;
        Literal to = null;
    ...
    @Override
    public void visit(UnitsList unitsList) throws Exception {
